...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Affichage du catalogue après éxécution de la premiere commande");
		catalogue.affiche();
		System.out.println();
		...
		System.out.println("Affichage du catalogue après éxécution de la seconde commande");
		catalogue.affiche();
		System.out.println();
		
		catalogue.annuleCommandeSolder(1);
		
		System.out.println("Affichage du catalogue après annulation de la premiere commande");
		catalogue.affiche();
		System.out.println();
		
		catalogue.retablitCommandeSolder(1);
		
		System.out.println("Affichage du catalogue après retablissement de la premiere commande");
		catalogue.affiche();
		System.out.println();
